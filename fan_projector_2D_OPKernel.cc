...
void Fan_Projection_Kernel_Launcher(const float *volume_ptr, float *out, const float *ray_vectors, const int number_of_projections,
                                    ...
                                    const int detector_width, const float detector_spacing, const float detector_origin, const float sid, const float sdd);
...
class FanProjection2DOp : public OpKernel
{
  ...
  public:
    ...
    void Compute(OpKernelContext *context) override
    {
        ...
        Fan_Projection_Kernel_Launcher(input.data(), output.data(), ray_vectors_.data(), number_of_projections,
